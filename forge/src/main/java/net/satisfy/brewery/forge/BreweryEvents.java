    ...
    public static class ForgeEvents {
        ...
        public static void addCustomTrades(VillagerTradesEvent event){
            if(event.getType().equals(BreweryForgeVillagers.BREWER.get())){
                ...
                level1.add(new VillagerUtil.SellItemFactory(ObjectRegistry.CORN_SEEDS.get(), 2, 3, 5));
                level1.add(new VillagerUtil.SellItemFactory(ObjectRegistry.BARLEY_SEEDS.get(), 2, 3, 5));
                ...
                level2.add(new VillagerUtil.SellItemFactory(ObjectRegistry.CORN.get(), 4, 2, 7));
                level2.add(new VillagerUtil.SellItemFactory(ObjectRegistry.BARLEY.get(), 4, 2, 7));
